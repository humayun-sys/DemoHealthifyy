                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="single-blog-card card border-0 shadow-sm">
                            ...
                            <img src="assets/img/blog/blog-01.jpg" class="card-img-top position-relative" alt="blog"/>
                            <div class="card-body">
                                ...
                                <h3 class="h5 card-title">Appropriately productize fully</h3>
                                <p class="card-text">Some quick example text to build on the card title and make up the bulk.</p>
                                {/* <a  class="detail-link">Read more <span class="ti-arrow-right"></span></a> */}
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="single-blog-card card border-0 shadow-sm">
                            ...
                            <img src="assets/img/blog/blog-02.jpg" class="card-img-top position-relative" alt="blog"/>
                            <div class="card-body">
                                <div class="post-meta mb-2">
                                    <ul class="list-inline meta-list">
                                ...
                                <h3 class="h5 card-title">>Quickly formulate backend</h3>
                    ...
                    <div class="col-md-4">
                        <div class="single-blog-card card border-0 shadow-sm">
                            ...
                            <img src="assets/img/blog/blog-03.jpg" class="card-img-top" alt="blog"/>
                            <div class="card-body">
                                <div class="post-meta mb-2">
                                    <ul class="list-inline meta-list">
                                ...
                                <h3 class="h5 card-title">Objectively extend extensive</h3>
                    ...
                    <div class="col-md-4">
                        <div class="single-blog-card card border-0 shadow-sm">
                            <span class="category position-absolute badge badge-pill badge-info">Science</span>
                            <img src="assets/img/blog/blog-04.jpg" class="card-img-top" alt="blog"/>
                            <div class="card-body">
                                <div class="post-meta mb-2">
                                    <ul class="list-inline meta-list">
                                        <li class="list-inline-item">Apr 25, 2019</li>
                    ...
                    <div class="col-md-4">
                        <div class="single-blog-card card border-0 shadow-sm">
                            <span class="category position-absolute badge badge-pill badge-info">Science</span>
                            <img src="assets/img/blog/blog-05.jpg" class="card-img-top" alt="blog"/>
                            <div class="card-body">
                                <div class="post-meta mb-2">
                                    <ul class="list-inline meta-list">
                                        <li class="list-inline-item">Apr 25, 2019</li>
                    ...
                    <div class="col-md-4">
                        <div class="single-blog-card card border-0 shadow-sm">
                            <span class="category position-absolute badge badge-pill badge-info">Science</span>
                            <img src="assets/img/blog/blog-06.jpg" class="card-img-top" alt="blog"/>
                            <div class="card-body">
                                <div class="post-meta mb-2">
                                    <ul class="list-inline meta-list">
                                        <li class="list-inline-item">Apr 25, 2019</li>
